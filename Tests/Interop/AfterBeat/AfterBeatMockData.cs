...
namespace BH.SDK.Tests.Interop.AfterBeat
{
    ...
    // this repository - see AfterBeatCorpusTests.
    internal static class AfterBeatMockData
    {
        ...
        public static VgdObject CreateObject(string id = ObjectSourceId)
        {
            var target = new VgdObject
            {
                Id = id,
                Name = "Square",
                ObjectType = (int)AfterBeatObjectType.Hit,
                StartTime = 1f,
                AutokillType = (int)AfterBeatAutokillType.LastKeyframe,
                Shape = (int)AfterBeatShape.Square,
                ShapeOption = 0,
        ...
        public static VgdLevel CreateFullLevel()
        {
            ...
            level.SetEvents(AfterBeatEventTrack.CameraPosition,
                new List<VgdEventKeyframe> { Event(0f, 1f, 2f) });
            level.SetEvents(AfterBeatEventTrack.CameraZoom,
                new List<VgdEventKeyframe> { Event(0f, 12f) });
            level.SetEvents(AfterBeatEventTrack.CameraRotation,
                new List<VgdEventKeyframe> { Event(0f, 45f) });
            level.SetEvents(AfterBeatEventTrack.CameraShake,
                new List<VgdEventKeyframe> { Event(0f, 0.5f) });
            level.SetEvents(AfterBeatEventTrack.Bloom,
                new List<VgdEventKeyframe> { Event(0f, 1f, 0.5f, 2f) });
            level.SetEvents(AfterBeatEventTrack.Vignette,
                new List<VgdEventKeyframe> { Event(0f, 0.3f, 0.4f, 1f, 0f, 0.5f, 0.5f, 1f) });
            level.SetEvents(AfterBeatEventTrack.Chromatic,
            ...
            level.SetEvents(AfterBeatEventTrack.Theme, new List<VgdEventKeyframe> { themeKey });
        ...
        public static VgmMeta CreateMeta()
        {
            ...
            meta.Song.Difficulty = (int)AfterBeatDifficulty.Advanced;
            meta.Creator.SteamName = "Creator";
            meta.Artist.Name = "Artist";
            meta.Artist.LinkType = (int)AfterBeatLinkType.Bandcamp;
