...
namespace BH.SDK.Interop.AfterBeat
{
    ...
    public static class AfterBeatValueMap
    {
            ...
            InteropReport report = null, string path = null)
        {
            ...
            switch ((AfterBeatRandomType)source.RandomType)
            {
                case AfterBeatRandomType.None:
                    return new FloatValue(value);

                case AfterBeatRandomType.Linear:
                    return MakeRange(value, value + random, interval);

                case AfterBeatRandomType.Toggle:
                ...
                case AfterBeatRandomType.Relative:
