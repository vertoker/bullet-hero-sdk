...
namespace BH.SDK.Interop.AfterBeat.Import
{
    ...
    public static class ABMetaImporter
    {
        ...
        public static string BuildArtistUrl(int linkType, string link)
        {
            ...
            return (ABLinkType)linkType switch
            {
                ABLinkType.Spotify => $"https://open.spotify.com/artist/{link}",
                ABLinkType.Soundcloud => $"https://soundcloud.com/{link}",
                ABLinkType.Bandcamp => $"https://{link}.bandcamp.com",
                ABLinkType.YoutubeMusic => $"https://music.youtube.com/channel/{link}",
                ABLinkType.Newgrounds => $"https://{link}.newgrounds.com",
                _ => string.Empty,
            };
        }
