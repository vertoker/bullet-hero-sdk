...
{
    // The mirror of AfterBeatImportContext. Two things it has to do that the import does not:
    //
    ...
    public class AfterBeatExportContext
    {
        ...
        public AfterBeatExportContext(AfterBeatOptions options, InteropReport report, IObjectScope scope)
        {
