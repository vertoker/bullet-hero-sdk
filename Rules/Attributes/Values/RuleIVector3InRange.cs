...
namespace BHSDK.Rules.Attributes
{
    ...
    public class RuleIVector3InRange : BaseRuleAttribute
    {
        // always include
        ...
        public RuleIVector3InRange(float min, float max)
        {
            MinX = min;
            MaxX = max;
            MinY = min;
        ...
        public RuleIVector3InRange(float minX, float maxX, float minY, float maxY, float minZ, float maxZ)
        {
            MinX = minX;
            MaxX = maxX;
            MinY = minY;
